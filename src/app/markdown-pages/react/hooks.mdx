...
1. 처음부터 리액트를 세팅하는 방법도 있다. 아티클을 참고하는 편이 좋다.
   ...
   - <a
       href="https://dev.to/underscorecode/creating-your-react-project-from-scratch-without-create-react-app-the-complete-guide-4kbc"
       target="_blank"
     >
       Creating your React project from scratch without create-react-app: The
       Complete Guide.
     </a>
